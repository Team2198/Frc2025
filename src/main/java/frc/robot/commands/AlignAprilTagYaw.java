...
public class AlignAprilTagYaw extends Command {
  /** Creates a new AlignAprilTagHorizontal. */
 private DriveSub drive; 
 private int pipeLine; 

  public AlignAprilTagYaw(DriveSub drive, int pipeLine) {
    this.drive = drive; 
  ...
  public void execute() {
    ...
    if (this.drive.getLimelightTV()){
      ...
      drive.followPathNew(new Pose2d(0, 0, new Rotation2d(Units.degreesToRadians(yaw))));
    }
  }
